...
|:-:|:-:|:-:|:-:|:-:|
|Cave Escape|-|-|-|・フォルダーを整理する<br>・実行ファイル名をゲーム名にする<br>・Credits<br>・カタカナにするか英語にするか表記を合わせる|
|ホップホップ|-|-|-|・README.txtを用意して、起動方法や操作方法などの基本的な内容を書いておく<br>・ライトの設定をRealtimeにする<br>・タイトルでESCキーでアプリ終了|
