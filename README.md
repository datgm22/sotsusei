...
|探偵はウイルス|完了|完了|完了|・既存のREADME.txtを作品用のものに差し替え<br>・セーブデータを消しておいたほうがよいかも<br>・config.tjsの;configSaveOverwriteをtrueに設定|
|ReVerser|発注済み|発注済み|完了|・README.txtを追加<br>・最終ステージに進めないことがある<br>・最終ステージのドアを開こうとするとドアの効果音がしたあと、操作不能になる|
