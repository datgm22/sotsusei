...
|ホップホップ|-|-|完了|・ライトの設定をRealtimeにする|
|探偵はウイルス|印刷完了|印刷完了|完了|完了|
|ReVerser|印刷完了|印刷待ち|完了|・左右重力反転のステージで、下の床から重力を反転させてリフトの反対側に着地すると、リフトが動いたあとに取り残されて操作不能になる<br>・最終ステージに進めないことがある<br>・最終ステージのドアを開こうとするとドアの効果音がしたあと、操作不能になる|
