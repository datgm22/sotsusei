...
|:-:|:-:|:-:|:-:|:-:|
|Cave Escape|-|印刷中|完了|完了|
|ホップホップ|原稿完成|完了|完了|・最新版を提出用フォルダーにコピー<br>・ライトの設定をRealtimeにする|
|探偵はウイルス|印刷完了|印刷完了|完了|完了|
|ReVerser|印刷完了|印刷完了|完了|以下、直せれば。<br>・左右重力反転のステージで、下の床から重力を反転させてリフトの反対側に着地するとリフトが動いたあとに取り残されて操作不能になる<br>・最終ステージの上下反転でカメラが上下に動くことで分かりにくくなるので固定できれば固定したい|
