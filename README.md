...
|:-:|:-:|:-:|:-:|:-:|
|Cave Escape|完了|完了|完了|完了|
|ホップホップ|完成|完了|完了|完了|
|探偵はウイルス|完了|完了|完了|完了|
|ReVerser|完了|完了|完了|完了。以下、直せれば。<br>・左右重力反転のステージで、下の床から重力を反転させてリフトの反対側に着地するとリフトが動いたあとに取り残されて操作不能になる<br>・ステージクリア時にボタンのフォーカスがステージ選択ボタンになっていることがある。ボタンの押しっぱなし？表示されてからしばらくはキーを反応させないなどで対応可能|
